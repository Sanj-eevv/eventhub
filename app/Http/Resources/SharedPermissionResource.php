...
final class SharedPermissionResource
{
     ...
     *     event: array{viewAny: bool, create: bool, update: bool, delete: bool, publish: bool, cancel: bool, checkIn: bool},
    ...
    public function toArray(): array
    {
        return [
            ...
            'event' => $this->checksFor(Event::class, ['viewAny', 'create', 'update', 'delete', 'publish', 'cancel', 'checkIn']),
