...
* @see app/Http/Controllers/Auth/EmailVerificationController.php:17
* @route '/email/verify'
*/
...
* @see app/Http/Controllers/Auth/EmailVerificationController.php:33
...
const EmailVerificationController = { index, verify, resend }
