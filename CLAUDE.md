...
- `phpstan-analysis` — Invoke BEFORE running PHPStan or fixing PHPStan errors. Covers error resolution strategy (refactoring > phpDoc > ignoring), baseline management, and type tests. Use this whenever the user mentions PHPStan, static analysis, type errors, or wants to suppress warnings - even for a single error.
